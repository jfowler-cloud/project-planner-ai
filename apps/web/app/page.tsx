      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Simple Questions</h3>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <div className="text-4xl mb-4">🚀</div>
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Ready to Build</h3>
            <p className="text-gray-600 dark:text-gray-400">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          ...
          <div className="space-y-4">
            {[
              ...
              { n: 2, title: "AI Planning Process", desc: "AI generates architecture options and performs 10 critical reviews" },
        ...
        <div className="mt-16 text-center">
          <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Cost Estimates</h3>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { label: "Small Project", price: "~$5", sub: "1-2 days timeline" },
              { label: "Medium Project", price: "~$12", sub: "1 week timeline" },
              { label: "Large Project", price: "~$30", sub: "2 weeks timeline" },
            ].map(({ label, price, sub }) => (
              <div key={label} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                <h4 className="font-semibold text-lg mb-2 text-gray-900 dark:text-white">{label}</h4>
                <p className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">{price}</p>
      ...
      <footer className="border-t border-gray-200 dark:border-gray-700 mt-16 py-8 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-gray-600 dark:text-gray-400">
          ...
          <p className="mt-2 text-sm">
            <a href="https://github.com/jfowler-cloud" className="text-blue-600 dark:text-blue-400 hover:underline">
              GitHub
            </a>
            {" · "}
            <a href="https://www.linkedin.com/in/james-fowler-aws-cloud-architect-dev-ops-professional/" className="text-blue-600 dark:text-blue-400 hover:underline">
              LinkedIn
            </a>
          </p>
        </div>
